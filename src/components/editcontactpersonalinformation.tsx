...
import { useRef, ChangeEvent, useEffect, useState, useContext } from 'react';
...
const EditContactPersonalInformation: FC<editPersonalInformationProps> = ({
  ...
  return (
    <div className="inline-block w-full max-h-[90vh] p-6 pt-6 pr-6 mt-10 overflow-y-scroll bg-white rounded-lg shadow-md fade-in md:mt-5">
