...
const SearchFiles: FC<SearchfilesProps> = ({ path }) => {
  ...
  return (
    <div className="relative z-10">
      <div className="relative flex items-center justify-between w-full pr-2 text-xs text-gray-500 transition-all bg-white border rounded-md border-suzy-gray text-border">
        <input
          type="text"
          name="search"
          autoComplete="off"
          ...
          className="w-full px-4 py-[5px] text-xs placeholder-gray-400 bg-transparent rounded-md outline-none text-default focus:bg-transparent"
      ...
      {showNoResults && (
        <p className="absolute text-xs text-gray-500 -bottom-5 left-2">
          No results...
        </p>
      )}
    </div>
